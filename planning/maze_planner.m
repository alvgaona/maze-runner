...
trajAS(:,3) = smoothdata(trajA(:,3), 'gaussian', 4);
...
trajRS(:,1) = smoothdata(trajR(:,1), 'gaussian', 3);
trajRS(:,2) = smoothdata(trajR(:,2), 'gaussian', 3);
trajRS(:,3) = smoothdata(trajR(:,3), 'gaussian', 3);
